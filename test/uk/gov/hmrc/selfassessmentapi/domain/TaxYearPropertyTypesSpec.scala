...
import uk.gov.hmrc.selfassessmentapi.controllers.api.TaxYearPropertyTypes
...
sealed case class TestTaxYearPropertyTypes(override val featureSwitch: FeatureSwitch) extends TaxYearPropertyTypes
