  ...
  "retrieveObligations" should {
    ...
    "return code 200 containing a set of canned obligations of which only the first has been met" in {
      given()
        ...
        .statusIs(201)
        .when()
        .get(s"/ni/$nino/uk-properties/obligations").withHeaders("X-Test-Scenario", "PROP_OB_FIRST_MET")
        .thenAssertThat()
        .statusIs(200)
    ...
    "return code 200 containing a set of canned obligations, all of which have been met" in {
      given()
        ...
        .statusIs(201)
        .when()
        .get(s"/ni/$nino/uk-properties/obligations").withHeaders("X-Test-Scenario", "PROP_OB_ALL_MET")
        .thenAssertThat()
        .statusIs(200)
