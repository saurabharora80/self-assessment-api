  ...
  "create" should {
    "return code 201 when creating a valid a self-employment resource" in {
      ...
      given()
        ...
        .thenAssertThat()
        .statusIs(201)
        .responseContainsHeader("Location", s"/nino/$nino/self-employments/\\w+".r)
    }
  ...
  "update" should {
    ...
    "return code 404 when attempting to update a non-existent self-employment resource" in {
      ...
      given()
        ...
        .statusIs(201)
        .when()
        .put(Some(selfEmployment2)).at(s"/nino/$nino/self-employments/invalidSourceId")
        .thenAssertThat()
        .statusIs(404)
    }
  }
  ...
  "retrieve" should {
    ...
    "return code 404 when retrieving a self-employment resource that does not exist" in {
      given()
        .userIsAuthorisedForTheResource(nino)
        .when()
        .get(s"/nino/$nino/self-employments/invalidSourceId")
        .thenAssertThat()
        .statusIs(404)
    }
  }
  ...
  "retrieveAll" should {
    "return code 200 when retrieving self-employments that exist" in {
      ...
      given()
        ...
        .statusIs(201)
        .when()
        .post(selfEmploymentTwo).to(s"/nino/$nino/self-employments")
        .thenAssertThat()
        .statusIs(201)
        .when()
  ...
  "updateAnnualSummary" should {
    ...
    "return code 404 when updating an annual summary for an invalid self-employment source" in {
      ...
      given()
        .userIsAuthorisedForTheResource(nino)
        .when()
        .put(Some(annualSummaries)).at(s"/nino/$nino/self-employments/sillysource/$taxYear")
        .thenAssertThat()
        .statusIs(404)
    }
  ...
  "retrieveAnnualSummary" should {
    ...
    "return code 404 when retrieving an annual summary for a non-existent self-employment source" in {
      given()
        .userIsAuthorisedForTheResource(nino)
        .when()
        .get(s"/nino/$nino/self-employments/sillyid/$taxYear")
        .thenAssertThat()
        .statusIs(404)
    }
  }
  ...
  "createPeriod" should {
    "return code 201 containing a location header when creating a period" in {
      ...
      given()
        ...
        .thenAssertThat()
        .statusIs(201)
        .responseContainsHeader("Location", s"/nino/$nino/self-employments/\\w+/periods/\\w+".r)
    }
